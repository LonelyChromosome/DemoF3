...
abstract final class DemoDataSeed {
  ...
  static const _differenceAssetPath = 'assets/demo/schedule_difference.json';
  ...
  static Future<void> seedIfEmpty() async {
    ...
    if (!preferences.containsKey(SemesterDifferenceStore.storageKey)) {
      final raw = await rootBundle.loadString(_differenceAssetPath);
      final difference = SemesterDifference.fromJson(
        Map<String, dynamic>.from(jsonDecode(raw) as Map<dynamic, dynamic>),
      );
      await SemesterDifferenceStore().save(difference);
    }
  }
}
